...
NII_FILE = "D:\\Pilot_Exp_VASO\\pilotAOM\\sub-04\\derivatives\\anat\\MNI_alignment\\visfAtlas_warp_slab_func.nii.gz"
FREESURFER_LUT = "D:\\Pilot_Exp_VASO\\pilotAOM\\sub-04\\derivatives\\anat\\MNI_alignment\\visf_slab.txt"
...
voi_file.write("OriginalVMRFramingCubeDim: 216\n")
voi_file.write("\n")
...
for i in labels:
    label = freesurfer_lut[str(i)][7]
    color = freesurfer_lut[str(i)][0:3]
