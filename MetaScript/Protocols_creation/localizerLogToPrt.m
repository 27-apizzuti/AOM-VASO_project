...
file = 'pilot06_locMt_AOM_Run01_2021_Jul_05_1302.log';
outPath = ['D:\Pilot_Exp_VASO\pilotAOM\', subj, '\Protocols\Protocols'];

%% Execute
fid = fopen(fullfile(mainPath,'\Logging', file));
...
prtFile.Experiment = [subj '_Pilot_MT_Localizer'];
...
xlabel('time in vol')
title('Run1')
exportgraphics(figH,fullfile(outPath, [subj '_Pilot_MT_Localizer.png']),'Resolution',300)
