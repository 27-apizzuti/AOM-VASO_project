...
Flattening 'thresholded_columnarity_map'
...
FUNC = ['BOLD', 'VASO']
threshold = 65   # Columnarity index threshold
...
for iterSbj, su in enumerate(SUBJ):
    ...
    for fu in FUNC:
        ...
        VALUE = os.path.join(PATH_IN, '{}_{}_BOLD_FDR_{}_columns_full_depth_UVD_columns_mode_filter_window_count_ratio_thr_{}.nii.gz'.format(su, ROI, fu, threshold))
        basename = '{}_{}_BOLD_FDR_{}_columnar_mask_thr_{}'.format(su, ROI, fu, threshold)
