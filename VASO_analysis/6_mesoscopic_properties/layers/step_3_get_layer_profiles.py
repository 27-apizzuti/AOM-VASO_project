...
Created on Thu Oct 14 18:43:35 2021
    Get BOLD and VASO Layer Profiles (0.2 iso mm) and Plot:

        Input: metric file, activation map (no thresholded) [percent signal change or t-map], set of voxels (mask)
        Output: plot layer profiles, 2D histograms of activation map across cortical depths
