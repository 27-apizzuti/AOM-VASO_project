...
for su in SUBJ:
    ...
    ROI = os.path.join(STUDY_PATH, su, 'derivatives', 'func', 'AOM',
                               'vaso_analysis', CONDT[0], 'layers_columns', 'res_pt2', '{}_{}_mask_fix_hd_scaled_4.nii.gz'.format(su, ROI_NAME))
    ...
    for fu in FUNC:
        ...
        # Export 5D nifti
        outname = os.path.join(PATH_OUT, "{}_{}_{}_5psc_scled_4_unthreshold.nii.gz".format(su, fu, ROI_NAME))
